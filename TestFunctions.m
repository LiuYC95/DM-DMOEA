...
switch testfunc
     case 'FDA1'
        ...
        Problem.XLow    = [0;-1*ones(DEC-1,1)];   % lower boundary of decision variables, it also defines the number of decision variables
        Problem.XUpp    = [1;1*ones(DEC-1,1)];    % upper boundary of decision variables
     ...
     case 'FDA3'
        ...
        Problem.NObj    = 2;              % number of objectives                               
        Problem.XLow    =[0;0;-1*ones(DEC-2,1)];   % lower boundary of decision variables, it also defines the number of decision variables
        Problem.XUpp    =ones(DEC,1);    % upper boundary of decision variables
    ...
    case  'DF3'
        ...
        Problem.NObj    = 2;             % number of objectives                               
        Problem.XLow    =[0;-1*ones(DEC-1,1)];  % lower boundary of decision variables, it also defines the number of decision variables
        Problem.XUpp    =[1;2*ones(DEC-1,1)];   % upper boundary of decision variables
    ...
    case 'DF7'
        ...
        Problem.XUpp    = [4;1*ones(DEC-1,1)];   % upper boundary of decision variables
    ...
    case 'DF12'
        ...
        Problem.NObj    = 3;              % number of objectives                               
        Problem.XLow    = [0;0;-1*ones(DEC-2,1)];  % lower boundary of decision variables, it also defines the number of decision variables
        Problem.XUpp    = [1;1;1*ones(DEC-2,1)];   % upper boundary of decision variables
...
%% DF11
    G=abs(sin(0.5*pi*t));
        ...
        y1=pi*G/6.0+(pi/2.0-pi*G/3.0)*x(1);
        y2=pi*G/6.0+(pi/2.0-pi*G/3.0)*x(2);
        f0=g*sin(y1) ;
        f1=g*sin(y2)*cos(y1);
        f2=g*cos(y2)*cos(y1);
    F = [f0
...
%% DF12   FDA4
    k=10*sin(pi*t);
        ...
        tmp2=abs(sin(floor(k*(2*x(1)-1))*pi/2.0)*sin(floor(k*(2*x(2)-1))*pi/2.0));
        g=1+sum(tmp1.^2)+tmp2;
